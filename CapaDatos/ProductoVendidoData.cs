...
namespace CapaDatos
{
    public static class ProductoVendidoData
    {
        ...
        public static List<ProductoVendido> ObtenerProductoVendido(int idProductoVendido,string conexion)
    {
    ...
    public static List<ProductoVendido> ListarProductoVendidos(string conexion)
    {
        List<ProductoVendido> lista = new List<ProductoVendido>();
        using (SqlConnection oconexion = new SqlConnection(conexion))
        {
    ...
    public static void EliminarProductoVendido(ProductoVendido objProductoVendido, string conexion)
    {
        ...
        public static void EliminarProductoVendidoById(int idProductoVendido, string conexion)
        {
            var query = "DELETE FROM ProductoVendido WHERE Id = @id";
            ...
            try
            {
                ...
                using (SqlConnection oconexion = new SqlConnection(conexion))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand(query, oconexion))
                    {
                        ...
                        cmd.Parameters.Add(new SqlParameter("Id", SqlDbType.Int) { Value = idProductoVendido });
                        cmd.ExecuteNonQuery();
                    }
