...
namespace CapaDatos
{
    ...
    {
        public static Venta ObtenerVenta(int idVenta,string conexion)
        {
        ...
        public static List<Venta> ListarVentas(string conexion)
        {
        ...
        public static void EliminarVentaById(int idVenta, string conexion)
        {
            var query = "DELETE FROM Venta WHERE Id = @id";
