...
namespace SistemaGestion
{
    public partial class frmVentas : Form
    {
        ...
        {
            dgvData.Rows.Clear();
            List<Venta> listaVentas = new CN_Venta().ListarVentas(conexion);

            foreach (Venta item in listaVentas)
            {
                Usuario usuario = CN_Usuario.ObtenerUsuario(item.idUsuario, conexion);
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (txtIdVenta.Text == "0")
            {
                ...
                CN_Venta.CrearVenta(objVenta, conexion);

                Usuario usuario = CN_Usuario.ObtenerUsuario(objVenta.idUsuario, conexion);
            ...
            else
            {
                ...
                CN_Venta.ModificarVenta(objVenta, conexion);
                if (txtIdVenta.Text != "0")
                {
        ...
        private void txtIdUsuario_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                Usuario usuario = CN_Usuario.ObtenerUsuario(Convert.ToInt32(txtIdUsuario.Text), conexion);
