...
namespace SistemaGestion
{
    public partial class frmProductosVendidos : Form
    {
        ...
        {
            dgvData.Rows.Clear();
            List<ProductoVendido> listaProductosVendidos = new CN_ProductoVendido().ListarProductoVendidos(conexion);

            dgvData.Columns["PrecioVenta"].DefaultCellStyle.Format = "N2";
            foreach (ProductoVendido item in listaProductosVendidos)
            {

                Producto producto = CN_Producto.ObtenerProducto(item.productoId, conexion);
        ...
        {
            lblOperacion.Text = " PRODUCTO VENDIDO";
        ...
        private void txtIdProducto_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                Producto producto = CN_Producto.ObtenerProducto(Convert.ToInt32(txtIdProducto.Text), conexion);
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (txtIdProductoVendido.Text == "0")
            {
                ...
                CN_ProductoVendido.CrearProductoVendido(objProductoVendido, conexion);
            ...
            else
            {
                ...
                CN_ProductoVendido.ModificarProductoVendido(objProductoVendido, conexion);
                if (txtIdProductoVendido.Text != "0")
                {
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            if (Convert.ToInt32(txtIdProducto.Text) != 0)
            {
                ...
                if (MessageBox.Show("Desea eliminar el Producto Vendido?", "Confirmar Eliminacion", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    CN_ProductoVendido.EliminarProductoVendido(objProducto, conexion);
        ...
        private void txtIdProductoVendido_TextChanged(object sender, EventArgs e)
        {
            ...
            if (txtIdProductoVendido.Text == "0")
                lblOperacion.Text = "PRODUCTO VENIDO";
            else
