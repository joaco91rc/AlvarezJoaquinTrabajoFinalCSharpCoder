...
namespace CapaDatos
{
    public static class ProductoData
    {
        ...
        public static List<Producto> ListarProductos(string conexion)
        {
        ...
        public static void EliminarProductoById(int idProducto, string conexion)
        {
            var query = "DELETE FROM Producto WHERE Id = @Id";
            ...
            {
                string mensaje = "Error en la Eliminacion del Producto:" + ex;
